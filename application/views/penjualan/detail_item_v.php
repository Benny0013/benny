                                            ...
                                            foreach($katalog as $z){
                                                if($z['id']==$i->id_katalog){
                                                    ...
                                                    foreach($custom as $c){{if($c->id==$k['id_produk']){if($c->id==$k['id_produk']){
                                                      ...
                                                      $setpos="";
                                                      if($c->id_katalog==1){
                                                        $setpos = "width:135px;height:55px;position:absolute; z-index: 1; left:190px;top:230px;";
                                                      }else if($c->id_katalog==2){
                                                        $setpos = "width:78px;height:55px;position:absolute; z-index: 1; left:203px;top:270px;";
                                                      }else if($c->id_katalog==3){
                                                        $setpos = "width:158px;height:352px;position:absolute; z-index: 3; left:165px;top:403px;";
                                                      }
