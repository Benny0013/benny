    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Custom Detail Add</h3>
            </div>
            <?php echo form_open('custom_detail/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						<label for="id_lengan" class="control-label"><span class="text-danger">*</span>Id Lengan</label>
						<div class="form-group">
							<input type="text" name="id_lengan" value="<?php echo $this->input->post('id_lengan'); ?>" class="form-control" id="id_lengan" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="id_badan" value="<?php echo $this->input->post('id_badan'); ?>" class="form-control" id="id_badan" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="id_kerah" value="<?php echo $this->input->post('id_kerah'); ?>" class="form-control" id="id_kerah" />
