...
{   
    ...
    function get_all_custom()
    {
        ...
        return $this->db->get('custom')->result_array();
    }
    ...
    private function _deleteImage($id)
    {
        ...
        if ($produk->path != "default.png") {
            $filename = explode(".", $custom->path)[0];
            return array_map('unlink', glob(FCPATH."uploads/custom/$filename.*"));
        }
    }
}
