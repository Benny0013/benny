    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Sunting Custom</h3>
            </div>
			<form action="<?php base_url('custom/edit') ?>" method="post" enctype="multipart/form-data">
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_katalog" class="form-control">
								...
								{
									$selected = ($katalog['id'] == $custom->id_katalog) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_bom" class="form-control">
								...
								{
									$selected = ($bom['id'] == $custom->id_bom) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="color" value="<?php echo ($this->input->post('color') ? $this->input->post('color') : $custom->color); ?>" class="form-control" id="color" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input class="form-control-file <?php echo form_error('path') ? 'is-invalid':'' ?>"
								 type="file" name="path" />
							<input type="hidden" name="old_image" value="<?php echo $custom->path ?>" />
