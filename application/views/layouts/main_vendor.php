<?php if($this->session->userdata('kode')==""){redirect('Vendor/login');}?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>Vendor Panel Chloe Hampers</title>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-right">
                                            <a href="<?php echo base_url('index.php/Vendor/logout');?>" class="btn btn-default btn-flat">Sign out</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="<?php echo site_url('Vendor/page');?>">
						...
						<li>
                            ...
                            <ul class="treeview-menu">
								<li class="active">
                                    <a href="<?php echo site_url('Pages/orderin_vendor');?>"><i class="fa fa-arrow-right"></i>Order Masuk</a>
                                </li>                                
                                <li>
                                    <a href="<?php echo site_url('Pages/joblistv');?>"><i class="fa fa-tasks"></i> Daftar Pengerjaan</a>
                                </li>
							</ul>
                        </li>
                    </ul>
