          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="id_karyawan" value="<?php echo $this->input->post('id_karyawan'); ?>" class="form-control" id="id_karyawan" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="estimasi" value="<?php echo $this->input->post('estimasi'); ?>" class="has-datepicker form-control" id="estimasi" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="alamat_pengiriman" class="form-control" id="alamat_pengiriman"><?php echo $this->input->post('alamat_pengiriman'); ?></textarea>
